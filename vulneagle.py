...
def main():
    ...
    EXTENDED_HELP = (
        ...
        "🔊 VERBOSE & QUIET MODES:\n\n"
        "  19. Verbose probing (detailed output):\n"
        "      vulneagle -l hosts.txt -live -v\n\n"
        "  20. Verbose enumeration:\n"
        "      vulneagle -d example.com -se -all -v\n\n"
        "  21. Verbose DNS brute:\n"
        "      vulneagle -d example.com -sb -w subs.txt -rf resolvers.txt -v\n\n"
        "  22. Verbose directory scan:\n"
        "      vulneagle -d https://example.com -db -w dirs.txt --recursion -v\n\n"
        "  23. Quiet mode (minimal output):\n"
        "      vulneagle -d example.com -se -all -q\n\n"
        "⚙️ API CONFIGURATION:\n\n"
        ...
        "  ✓ Enhanced verbose mode (-v) with detailed logging\n"
        "  ✓ 3x faster probing (100 threads, connection pooling)\n"
        "  ✓ Auto-save to results/ folder\n"
        ...
        "  • Use -v for verbose mode (detailed diagnostic output)\n"
        "  • Use -q for quiet mode (minimal output)\n"
        "  • -mc works in: subdomain enum, subdomain brute, directory brute\n"
        "  • Verbose mode shows: threads, timeouts, resolvers, filtering stats\n\n"
        "🔗 MORE INFO:\n"
